...
url = Filtering(["어린 마법사 해리포터는 11번째 생일에 자신이 마법사이며 호그와트 마법 학교에 입학했다는 것을 알게 됩니다. 그는 마법 여행을 시작하면서 자신의 과거를 밝혀내고, 한때 부모님을 죽인 어둠의 마법사와 마주하며, 선과 악의 싸움을 벌이는 마법 세계에서 자신의 중요한 역할을 깨닫게 됩니다.",
